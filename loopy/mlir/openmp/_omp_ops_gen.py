...
class AtomicReadOp(_ods_ir.OpView):
  ...
  def __init__(self, x, v, *, hint_val=None, memory_order_val=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class AtomicWriteOp(_ods_ir.OpView):
  ...
  def __init__(self, address, value, *, hint_val=None, memory_order_val=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CancelOp(_ods_ir.OpView):
  ...
  def __init__(self, cancellation_construct_type_val, *, if_expr=None, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    if if_expr is not None: operands.append(get_op_result_or_value(if_expr))
    _ods_context = extend_opview_class(loc)
...
class ParallelOp(_ods_ir.OpView):
  ...
  def __init__(self, allocate_vars, allocators_vars, reduction_vars, *, if_expr_var=None, num_threads_var=None, reductions=None, proc_bind_val=None, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    operands.append(get_op_result_or_value(if_expr_var) if if_expr_var is not None else None)
    operands.append(get_op_result_or_value(num_threads_var) if num_threads_var is not None else None)
...
class SimdLoopOp(_ods_ir.OpView):
  ...
  def __init__(self, lowerBound, upperBound, step, aligned_vars, nontemporal_vars, *, alignment_values=None, if_expr=None, order_val=None, simdlen=None, safelen=None, inclusive=None, loc=None, ip=None):
    ...
    operands.append(get_op_result_or_value(if_expr) if if_expr is not None else None)
...
class TargetOp(_ods_ir.OpView):
  ...
  def __init__(self, *, if_expr=None, device=None, thread_limit=None, nowait=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.append(get_op_result_or_value(thread_limit) if thread_limit is not None else None)
    _ods_context = extend_opview_class(loc)
    if bool(nowait): attributes["nowait"] = _ods_ir.UnitAttr.get(
      extend_opview_class(loc))
    _ods_successors = None
...
class DataOp(_ods_ir.OpView):
  ...
  def __init__(self, use_device_ptr, use_device_addr, map_operands, map_types, *, if_expr=None, device=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    _ods_context = extend_opview_class(loc)
    attributes["map_types"] = (map_types if (
    issubclass(type(map_types), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I64ArrayAttr')) else
      _ods_ir.AttrBuilder.get('I64ArrayAttr')(map_types, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
      successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class EnterDataOp(_ods_ir.OpView):
  ...
  def __init__(self, map_operands, map_types, *, if_expr=None, device=None, nowait=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TaskLoopOp(_ods_ir.OpView):
  ...
  def __init__(self, lowerBound, upperBound, step, in_reduction_vars, reduction_vars, allocate_vars, allocators_vars, *, inclusive=None, if_expr=None, final_expr=None, untied=None, mergeable=None, in_reductions=None, reductions=None, priority=None, grain_size=None, num_tasks=None, nogroup=None, loc=None, ip=None):
    ...
    operands.append(get_op_results_or_values(step))
    operands.append(get_op_result_or_value(if_expr) if if_expr is not None else None)
    operands.append(get_op_result_or_value(final_expr) if final_expr is not None else None)
    operands.append(get_op_results_or_values(in_reduction_vars))
    operands.append(get_op_results_or_values(reduction_vars))
    operands.append(get_op_result_or_value(priority) if priority is not None else None)
    operands.append(get_op_results_or_values(allocate_vars))
    operands.append(get_op_results_or_values(allocators_vars))
    operands.append(get_op_result_or_value(grain_size) if grain_size is not None else None)
    operands.append(get_op_result_or_value(num_tasks) if num_tasks is not None else None)
    _ods_context = extend_opview_class(loc)
    if bool(inclusive): attributes["inclusive"] = _ods_ir.UnitAttr.get(
      extend_opview_class(loc))
  ...
  def allocators_vars(self):
    operand_range = segmented_accessor(
         self.operation.operands,
         self.operation.attributes["operand_segment_sizes"], 9)
    return operand_range
  ...
  def grain_size(self):
    operand_range = segmented_accessor(
         self.operation.operands,
         self.operation.attributes["operand_segment_sizes"], 10)
    return operand_range[0] if len(operand_range) > 0 else None
  ...
  def num_tasks(self):
    operand_range = segmented_accessor(
         self.operation.operands,
         self.operation.attributes["operand_segment_sizes"], 11)
    return operand_range[0] if len(operand_range) > 0 else None
...
class TaskOp(_ods_ir.OpView):
  ...
  _ODS_OPERAND_SEGMENTS = [0,0,-1,0,-1,-1,]

  _ODS_REGIONS = (1, True)

  def __init__(self, in_reduction_vars, allocate_vars, allocators_vars, *, if_expr=None, final_expr=None, untied=None, mergeable=None, in_reductions=None, priority=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class WsLoopOp(_ods_ir.OpView):
  ...
  def __init__(self, lowerBound, upperBound, step, linear_vars, linear_step_vars, reduction_vars, *, reductions=None, schedule_val=None, schedule_chunk_var=None, schedule_modifier=None, simd_modifier=None, nowait=None, ordered_val=None, order_val=None, inclusive=None, loc=None, ip=None):
    ...
    operands.append(get_op_results_or_values(reduction_vars))
    operands.append(get_op_result_or_value(schedule_chunk_var) if schedule_chunk_var is not None else None)
    _ods_context = extend_opview_class(loc)
    if reductions is not None: attributes["reductions"] = (reductions if (
        issubclass(type(reductions), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('SymbolRefArrayAttr')) else
