...
public:
  ...
  /**
   *  This exception is raised when the library failed to load a dynamic library
   * or a symbol
   *
  ...
  /**
   *  This exception is raised when the library failed to load or encountered
   ...
   *
   *  @param dir_path the directory path where is located the dynamic library
   * you want to load
   ...
   *  @param symbol_name the symbol name of a function to get from the dynamic
   * library
   *
  ...
  template <typename T> T *get_function(const std::string &symbol_name) const {
   ...
   *  @param symbol_name the symbol name of a variable to get from the dynamic
   * library
   *
  ...
  template <typename T> T &get_variable(const std::string &symbol_name) const {
...
protected:
  ...
  static std::string get_error_description() noexcept {
    ...
    return (description == nullptr) ? "Unknown error (dlerror failed)"
                                    : description;
#endif
  }
};
